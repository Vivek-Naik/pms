    ...
    <div class="content" style="margin-top: 40px; margin-left: -30px;">
    	...
    	<?php 
          ...
          <ul style="list-style: square;">
            <li class="lead" style=" font-family: 'Helvetica, Arial', sans-serif;"><a href="viewcompanies.php?id=<?php echo $row['id']; ?>" class="text-dark"><?php echo $row['company']; ?></a></li>
          </ul>
          </form>
          <?php
    	}
       ...
       <br>
       <br> 
       <div class="form-text" align="center" style="margin-left: 100px;">
        <a href="category.php" class="btn btn-sm btn-danger" style="font-size: 20px;">Apply Now</a>
