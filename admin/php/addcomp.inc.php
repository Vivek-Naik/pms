<?php 
	...
	if (isset($_POST['add'])) {
		...
		$sql1 = "INSERT INTO `company` (`id`, `name`,`type`, `address`, `number`, `website`, `status`,`Role`) VALUES (NULL, '$cname', '$ctype', '$address', '$phone', '$website', '$status','$jobOptions');";
	...
	if (isset($_POST['update'])) {
		...
		$sql = "update company set name='$cname', website='$website', address='$address', type='$ctype', status='$status', number='$phone',Role='$jobOptions', minperc='$minperc' where id='$cid';";
